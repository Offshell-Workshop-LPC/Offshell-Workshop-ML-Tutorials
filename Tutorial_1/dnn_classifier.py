...
def baseline_model():
    ...
    model.add(Dense(300, input_dim=len(INPUT_VAR_NAMES), activation='relu'))
...
X_train, X_test, Y_train, Y_test, W_train, W_test = train_test_split(X, Y, W, test_size=.15, random_state=123)
